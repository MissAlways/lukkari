...
public class KurssiServlet extends HttpServlet {
	...
	private ArrayList<Lukkarikurssi> kurssitTI = new ArrayList<Lukkarikurssi>(); // Tiistain kurssit
	private ArrayList<Lukkarikurssi> kurssitTO = new ArrayList<Lukkarikurssi>(); // Torstain kurssit
	private ArrayList<Kurssi> lukkarilista = new ArrayList<Kurssi>();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {		
		if (alustus) {
			ArrayList<Opetusaika> aikalista = new ArrayList<Opetusaika>();
		...
		} else if (request.getParameter("ilmoittaudu") != null && lukkarilista.contains(kurssi)) {
